...
&#8202;<span class="project-name">Pablo</span> is a high-performance JavaScript wrapper library for SVG ([scalable vector graphics][svg]). It's a bit like [Raphaël][raphael] + [jQuery][jquery] + [Underscore][_]. In just 3KB.
