...
See also `Pablo.cssPrefix()` in the 'Utilities & advanced' section. It can return either comma-separated CSS property names, or semicolon-separated CSS rules for creating on-the-fly stylesheets.
