...
(function(){
        ...
        css: (function(){
            ...
            function prefixTransitionProperties(transitionValue){
                var ret = '',
                    ...
                    prop, resolvedProp, camelCaseName, separator, isPrefixed;
        ...
        bbox: function(){
            ...
            if (allInDocument){
                if (this.length === 1){
                    ...
                    total = this.reduce(function(bbox, el, i, collection){
    ...
    (function(){
        // Test browser support for css transforms and transitions
        var testElement = make('line'),
        ...
        extend(pabloCollectionApi, {
            dataUrl: support.dataUrl ?
                function(type, callback, asFragment){
                    var collection = this,
                        asCompleteFile, target, markup, data, dataUrl;
